...
class S {
  ...
  String get createaccountaAs {
    return Intl.message(
      'create an account as',
      name: 'createaccountaAs',
      desc: '',
      args: [],
    );
  }
  ...
  String get errorSecondName {
    return Intl.message(
      'The second name must not be empty',
      name: 'errorSecondName',
      desc: '',
      args: [],
    );
  }
  ...
  String get errorServiceType {
    return Intl.message(
      'Please select a service type',
      name: 'errorServiceType',
      desc: '',
      args: [],
    );
  }
